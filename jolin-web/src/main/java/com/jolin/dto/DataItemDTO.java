...
public class DataItemDTO extends BaseTreeDTO {
    ...
    public DataItemDTO(String id, String parentId, String code, Integer orderIndex, String name, String state, String dataItemTypeId, String dataItemTypeName, String path) {
        super.setId(id);
